...
public class Permutation {
    public static void permutataionIterative(String word) {
    ...
    public static void permutationRecursive(String word, String permutatedWord) {
        ...
        for (int index = 0; index < word.length(); index++) {
            ...
            permutationRecursive(restOfString, permutatedWord + ithChar);
        }
    }
